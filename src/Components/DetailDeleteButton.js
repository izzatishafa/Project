...
// const DetailDeleteButton = ({ onClick, data }) => {
...
//       <button
//         onClick={toggleModal}
//         className={`bg-cyan text-white p-2 rounded-bl-md rounded-tl-md hover:bg-hv-cyan`}
//       >
...
//             </div>
//             {data.position === "PKL" && (
//               <p className="text-left text-dark-blue font-bold font-poppins pb-10 pl-10">
//                 {data.desc}
//               </p>
//             )}
...
//               ))}
//             </div>
//             {data.position === "Bootcamp" && (
//               <p className="text-left text-dark-blue font-bold font-poppins pb-5 pl-10">
//                 {data.kendala}
//               </p>
//             )}
...
// <button
//   onClick={onClick}
//   className={`bg-red text-white p-2 rounded-br-md rounded-tr-md hover:bg-hv-red`}
// >
...
export default function DetailDeleteButton({ onClick, data }) {
  const [isOpen, setIsOpen] = useState(false);
  ...
  return (
    <div className="flex flex-row justify-center p-2 gap-0">
      <button
        onClick={toggleModal}
        className={`bg-cyan w-[45px] text-white px-2 py-1 rounded-bl-md rounded-tl-md hover:bg-hv-cyan relative z-9`}
      >
        <FontAwesomeIcon icon={faCircleInfo} className="px-1" />
      </button>
      <Modal isOpen={isOpen} onRequestClose={toggleModal} className="Modal">
