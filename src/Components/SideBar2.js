          ...
          >
            <li className="">
              <NavLink
                ...
                isActive={(match, location) => parentPath === "/"}
              >
                <FiHome
                  size={23}
                  color={parentPath === "/" ? "#0A1D33" : "gray"}
            ...
            <li className="">
              <NavLink
                exact
                to="/daily-report-admin"
                className="py-4 px-3 flex flex-row gap-6 md:cursor-pointer cursor-default duration-300"
                activeClassName="text-dark-blue"
                isActive={(match, location) =>
                  parentPath === "/daily-report-admin"
                }
              >
                <FiEdit
                  size={23}
            ...
            <li className="">
              <NavLink
                ...
                activeClassName="text-dark-blue"
                isActive={(match, location) =>
                  parentPath === "/score-admin"
                }
              >
                <FiShoppingBag
                  size={23}
                  color={
                    parentPath === "/score-admin" ? "#0A1D33" : "gray"
                  }
                  className="text-dark-blue min-w-max"
                />
                <p
            ...
            <li className="">
              <NavLink
                ...
                activeClassName="text-dark-blue"
                isActive={(match, location) =>
                  parentPath === "/notifications-admin"
                }
              >
                <FiBell
                  size={23}
            ...
            <li className="">
              <NavLink
                ...
                className="py-4 px-3 flex flex-row gap-6 md:cursor-pointer cursor-default duration-300"
                activeClassName="text-dark-blue"
                isActive={(match, location) => parentPath === "/agenda2"}
              >
                <FiCalendar
                  size={23}
                  color={parentPath === "/agenda2" ? "#0A1D33" : "gray"}
                  className="text-dark-blue min-w-max"
                />
                <p
                  className={`font-poppins text-[16px] font-bold ${
