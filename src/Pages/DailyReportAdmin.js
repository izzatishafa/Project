...
const DailyReportAdmin = () => {
    ...
    const agenda = [
      { DATE: '4/3/2023', NAME: 'Macaroni El Matadore', ACTIVITY: 'Membuat CRUD' },
      { DATE: '4/3/2023', NAME: 'Fatima Rusalka', ACTIVITY: 'Membuat CRUD' },
      { DATE: '4/3/2023', NAME: 'Jane Doe', ACTIVITY: 'Membuat CRUD' },
      { DATE: '4/3/2023', NAME: 'Tole', ACTIVITY: 'Membuat CRUD' },
      { DATE: '4/3/2023', NAME: 'Macaroni El Matadore', ACTIVITY: 'Membuat CRUD' },
      { DATE: '4/3/2023', NAME: 'Tole', ACTIVITY: 'Membuat CRUD' },
      { DATE: '4/3/2023', NAME: 'Jane Doe', ACTIVITY: 'Membuat CRUD' },
      { DATE: '4/3/2023', NAME: 'Fatima Rusalka', ACTIVITY: 'Membuat CRUD' },
        ...
        <table className="w-full border-collapse">
          <thead className={`bg-slate-gray`}>
            <tr>
              ...
              <th className={`font-poppins text-white lg:text-base sm:text-sm font-thin p-2`}>NAME</th>
              <th className={`font-poppins text-white lg:text-base sm:text-sm font-thin p-2`}>ACTIVITY</th>
          ...
          <tbody>
            ...
            <tr key={agenda.id}>
                ...
                <td className="border p-2 text-center font-poppins text-light-gray text-sm">{agenda.NAME}</td>
                <td className="border p-2 text-center font-poppins text-light-gray text-sm">{agenda.ACTIVITY}</td>
                <td className="border"><DetailBtn /></td>
            </tr>
            ))}
