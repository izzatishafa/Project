  ...
  return (
      ...
      <div className="grid lg:grid-cols-3 sm:grid-cols-1 gap-5 mx-12 mb-6">
              ...
              <div className={`bg-card-blue rounded-tl-md rounded-tr-md`}>
                  <div className="flex flex-row justify-between items-center p-5 ">
                      <div className="flex flex-col">
                        <h1 className={`text-white font-poppins font-bold text-3xl`}>10</h1>
                        <p className={`text-white text-sm font-poppins font-thin`}>User Intern</p>
                      </div>
            ...
            <div className="rounded-md">
              <div className={`bg-card-green rounded-tl-md rounded-tr-md`}>
                  <div className="flex flex-row justify-between items-center p-5 ">
                      <div className="flex flex-col">
                        <h1 className={`text-white font-poppins font-bold text-3xl`}>4</h1>
                        <p className={`text-white text-sm font-poppins font-thin`}>Agenda for this Month</p>
                      </div>
            ...
            <div className="rounded-md">
              <div className={`bg-card-red rounded-tl-md rounded-tr-md`}>
                  <div className="flex flex-row justify-between items-center p-5 ">
                      <div className="flex flex-col">
                        <h1 className={`text-white font-poppins font-bold text-3xl`}>5</h1>
                        <p className={`text-white text-sm font-poppins font-thin`}>New Daily Report</p>
                      </div>
    ...
    <div className={`grid lg:grid-cols-2 sm:grid-cols-1 gap-12 mr-3`}>
            ...
            <div className="shadow-md rounded-md hover:shadow-xl">
                ...
                <div className="flex flex-row items-center ml-10 my-3">
                    <div>
                        <p className={`text-dark-gray font-poppins`}>Post Test menunggu...</p>
                        <p className={`text-sm text-left text-light-gray font-poppins`}>10 minutes ago</p>
                    </div>
                </div>
                <div className="flex flex-row items-center ml-10 my-3">
                    <div>
                        <p className={`text-dark-gray font-poppins`}>Tugas menunggu penilaian...</p>
                        <p className={`text-sm text-left text-light-gray font-poppins`}>10 minutes ago</p>
                    </div>
                </div>
                <div className="flex flex-row items-center ml-10 my-3">
            ...
            <div className="shadow-md rounded-md hover:shadow-xl">
                ...
                <div className="flex flex-row items-center">
                    ...
                    <div>
                        <p className={`text-dark-gray font-poppins`}>John telah submit...</p>
                ...
                <div className="flex flex-row items-center">
                    ...
                    <div>
                        <p className={`text-dark-gray font-poppins`}>Tole telah submit...</p>
                        <p className={`text-sm text-left text-light-gray font-poppins`}>5 minutes ago</p>
                    </div>
                </div>
                <div className="flex flex-row items-center">
