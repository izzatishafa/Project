    ...
    <div className="grid grid-cols-1 gap-4 ml-16 mr-10 mt-5 pb-10 shadow-md rounded-md">
      ...
      <div className="flex lg:flex-row sm:flex-col gap-4">
        <div className="flex flex-col px-14 w-full">
          <div>
            <p className={`font-poppins text-black`}>
              Agenda Kegiatan <span className="text-red">*</span>
            </p>
            <input
              type="text"
              required
          ...
          <div className="w-full pt-3">
            <p className={`font-poppins text-black`}>
              Rincian Kegiatan <span className="text-red">*</span>
            </p>
            <textarea
        ...
        <div className="flex flex-col px-14 w-full">
          <div>
            <p className={`font-poppins text-black`}>
              Penerima <span className="text-red">*</span>
            </p>
            <input
              type="text"
              required
          ...
          <div>
            <p className={`font-poppins text-black pt-2`}>
              PIC <span className="text-red">*</span>
            </p>
            <input
              type="text"
              required
              placeholder="contoh nama pic"
              className={`placeholder-light-gray font-poppins text-sm border-2 w-full rounded-md py-1 px-2 my-4 outline-none`}
            />
          </div>
